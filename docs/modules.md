...
| `calccode/optimize.py` | Bisection, Newton, secant, with iteration histories | [12](../notes/12-optimize.md) | [test_optimize.py](../tests/test_optimize.py) | [ex_optimize.py](../exercises/ex_optimize.py) |
