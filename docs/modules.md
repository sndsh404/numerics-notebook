...
| `calccode/integrators.py` | Explicit Euler, semi-implicit Euler, RK4, adaptive RK45 (Dormand-Prince), backward Euler | [04](../notes/04-integrators.md), [32](../notes/32-stiff-odes.md) | [test_integrators.py](../tests/test_integrators.py) | none |
...
| `calccode/fourier.py` | Hand-written O(n^2) DFT and radix-2 FFT, inverses, dominant frequency detection, timing comparison | [15](../notes/15-fourier.md), [31](../notes/31-fft.md) | [test_fourier.py](../tests/test_fourier.py) | [ex_fourier.py](../exercises/ex_fourier.py) |
| `calccode/montecarlo.py` | Xorshift RNG, RANDU weak LCG, 1D and n-D integration, pi estimation, importance sampling | [16](../notes/16-monte-carlo.md) | [test_montecarlo.py](../tests/test_montecarlo.py) | [ex_montecarlo.py](../exercises/ex_montecarlo.py) |
